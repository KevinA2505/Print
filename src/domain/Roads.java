...
public final class Roads {
	...
	/*
	 * Recorre todos los vértices del grafo y llena sus listas de carreteras
	 * horizontales y verticales según su posición en la cuadrícula.
	 */
	...
	/*
	 * A partir de la intersección dada, avanza en la dirección indicada (dr, dc) y
	 * agrega todas las coordenadas de la carretera hasta llegar a otra intersección
	 * o salir del tablero.
	 */
	...
	/*
	 * Verifica que la posición (r, c) esté dentro de los límites del tablero.
	 */
	...
	/*
	 * Comprueba si la posición corresponde con una intersección del grafo, es
	 * decir, si coincide con los múltiplos del tamaño de bloque.
	 */
