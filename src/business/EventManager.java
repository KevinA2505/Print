...
public class EventManager {
	...
	/*
	 * Relamente lo que hace es escoger una calle aleatoria de un nodo del grafo
	...
	/*
	 * Inicia el hilo. Elige evento cada nt waitTime = r.nextInt(11) + 10; // entre
	 * 10 y 20 segundos Thread.sleep(waitTime * 1000);
	 */
